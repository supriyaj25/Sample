...
public class Opportunities_Tc_50 {
	...
	public static void main(String[] args) {
		...
		se.selectByVisibleText("Support Group");
		...
		{
		System.out.println("Opportunity name verifed==pass");

		}
		else
		{
		System.out.println("Opportunity name not verified==fail");	
		}
		String expstr="Support Group";
		WebElement w3=driver.findElement(By.xpath("//a[contains(text(),'Support Group')]"));
